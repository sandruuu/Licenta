...
// the PDP control plane to push fan-out notifications such as device push
// challenges and internal state-change events to long-lived subscribers over
// Server-Sent Events.
//
// Design goals:
...
const (
	...
	TopicPushChallenge    = "push.challenge"    // payload: PushChallenge (per-device topic suffix)
