...
func requiredDurationSettings(cfg *config.Config) map[string]time.Duration {
	return map[string]time.Duration{
		...
		"runtime.admin_access_token_ttl":         cfg.Runtime.AdminAccessTokenTTL,
		"runtime.admin_session_idle_ttl":         cfg.Runtime.AdminSessionIdleTTL,
		"runtime.admin_session_absolute_ttl":     cfg.Runtime.AdminSessionAbsoluteTTL,
		"runtime.agent_session_access_token_ttl": cfg.Runtime.AgentSessionAccessTokenTTL,
		"runtime.agent_session_idle_ttl":         cfg.Runtime.AgentSessionIdleTTL,
		"runtime.agent_session_absolute_ttl":     cfg.Runtime.AgentSessionAbsoluteTTL,
