...
func defaultCatalogCachePath() string {
	return filepath.Join(defaultStateDir(), defaultCatalogCacheName)
}

func defaultStateDir() string {
	if value := strings.TrimSpace(os.Getenv("ZTNA_AGENT_STATE_DIR")); value != "" {
	...
	return filepath.Join(programData, "ZTNA", "Agent")
}
