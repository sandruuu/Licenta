...
type Config struct {
	...
	OIDCIssuerURL   string `json:"oidc_issuer_url,omitempty"`   // Defaults to cloud_url
	OIDCClientID    string `json:"oidc_client_id,omitempty"`    // Native public client, default "connect-app"
	OIDCScopes      string `json:"oidc_scopes,omitempty"`       // Default "openid profile email offline_access"
