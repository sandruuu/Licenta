...
const (
	...
	agentEnrollmentValidateAccessTokenPath  = "/ztna.agent.v1.AgentEnrollmentService/ValidateAccessToken"
	agentEnrollmentEnrollDevicePath         = "/ztna.agent.v1.AgentEnrollmentService/EnrollDevice"
	agentEnrollmentRenewCertificatePath     = "/ztna.agent.v1.AgentEnrollmentService/RenewCertificate"
)
